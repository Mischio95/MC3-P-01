...
struct Utilities
{
    ...
    struct ZIndex
    {
        ...
        static let frontSceneObject: CGFloat = CGFloat(6)
        static let enemy: CGFloat = CGFloat(7)
        static let player: CGFloat = CGFloat(8)
        static let layer8: CGFloat = CGFloat(9)
        static let layer9: CGFloat = CGFloat(10)
        static let layer10: CGFloat = CGFloat(11)
        static let HUD: CGFloat = CGFloat(80)
        static let backgroundVideo: CGFloat = CGFloat(90)
